                            ...
                            <div className="my-5">
                                ...
                                <div className="text-sm-center">
                                    <div className="py-5 buttons">
                                        <a href="https:/growithyou.com"><button className="btn btn-filled-white font-weight-bold">ПІДПИСАТИСЯ</button></a>
                ...
                <div className="container">
                    ...
                    <div className="col-md-6 col-12">
                        <div className="mx-auto">
                            ...
                            <div className="text-sm-center">
                                <div className="py-5 buttons">
                                    <a href="https:/growithyou.com"><button className="btn btn-filled-purple font-weight-bold">ПІДПИСАТИСЯ</button></a>
                                    <Link to={'/givetoys'}><button className="btn btn-outlined-pink font-weight-bold">ВІДДАТИ ІГРАШКИ</button></Link>
                                </div>
                            </div>
                        </div>
